...
INSERT INTO BUDGETS(CATEGORY_ID, PERIOD_CODE, AMOUNT, START_DATE, END_DATE, CURRENCY_CODE, IS_DELETED)
VALUES (1, 'MONTH', 30000,
PARSEDATETIME('2024-12-31 17:00:00', 'yyyy-MM-dd HH:mm:ss'),
PARSEDATETIME('2025-01-31 16:59:59', 'yyyy-MM-dd HH:mm:ss'),
'RUB', false);